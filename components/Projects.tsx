...
import { ArrowUpRight, ExternalLink, Sparkles, X, CheckCircle2, ChevronRight, Zap, ChevronLeft } from 'lucide-react';
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-10">
            ...
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-between px-4 md:px-12 pointer-events-none z-[210]">
              <button 
                onClick={handlePrev}
                className="w-14 h-14 bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 rounded-full flex items-center justify-center text-white transition-all pointer-events-auto active:scale-95 shadow-2xl"
              >
                <ChevronLeft size={32} />
              </button>
              <button 
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div className={`w-full md:w-2/5 p-10 ${selectedProject.color} flex flex-col justify-between relative overflow-hidden shrink-0`}>
                ...
                {/* Main Detail Content */}
                <div className="w-full md:w-3/5 p-10 md:p-16 overflow-y-auto bg-slate-950/50 scrollbar-hide">
