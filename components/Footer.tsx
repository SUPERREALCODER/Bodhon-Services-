        ...
        <div className="flex flex-col items-center md:items-start">
          <div className="flex items-center space-x-3 mb-4">
            <div className="w-8 h-8 flex items-center justify-center">
              <img src="../assets/logo.png" alt="Bodhon Phoenix" className="w-full h-full object-contain rounded-md" />
            </div>
            <span className="text-xl font-bold text-white tracking-tight">Bodhon</span>
          </div>
          <p className="text-slate-500 text-sm">Awakening Your Ideas. All rights reserved.</p>
        </div>
